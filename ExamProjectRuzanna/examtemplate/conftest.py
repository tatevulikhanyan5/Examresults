...
from ExamProjectRuzanna.examtemplate.POM.Pages.Home_page import HomePage
from ExamProjectRuzanna.examtemplate.POM.Pages.My_bag_page import MyBag
...
def get_driver(request, get_browser):
    ...
    request.cls.mybagpage = MyBag(driver)
