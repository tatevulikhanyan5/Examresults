...
from MariaExamProject.examtemplate.POM.Pages.home_page import HomePage
from MariaExamProject.examtemplate.POM.Pages.sale_page import SalePage
...
def get_driver(request, get_browser):
    ...
    request.cls.salepage = SalePage(driver)
