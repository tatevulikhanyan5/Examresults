...
from six_pm_project.POM.pages.accessories_page import AccessoriesPage
...
from six_pm_project.POM.pages.search_result_page import SearchPage
...
def get_driver(request, get_browser):
    ...
    request.cls.searchresultpage = SearchPage(driver)
    request.cls.accessoriespage = AccessoriesPage(driver)
