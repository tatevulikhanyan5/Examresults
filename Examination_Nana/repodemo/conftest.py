...
from Examination_Nana.repodemo.histories_project.TestingData import test_data
from Examination_Nana.repodemo.histories_project.POM.lib.helpers import Helpers
from Examination_Nana.repodemo.histories_project.POM.pages.Home_page_6pm import HomePage
from Examination_Nana.repodemo.histories_project.POM.pages.Womans_products import WomansPage
...
def get_driver(request, get_browser):
    ...
    request.cls.womanpage = WomansPage(driver)
