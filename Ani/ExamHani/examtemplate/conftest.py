...
from Ani.ExamHani.examtemplate.POM.pages.Accessories_page import AccPage
from Ani.ExamHani.examtemplate.POM.pages.Hats_page import FirstCheckbox
from Ani.ExamHani.examtemplate.POM.pages.HomePage import HomePage
...
def get_driver(request, get_browser):
    ...
    request.cls.accessoriespages = AccPage(driver)
    request.cls.hatspages= FirstCheckbox(driver)
    yield driver
    driver.quit()
