...
from POM_Vika.lib.assertions import assert_that
from POM_Vika.lib.helpers import Helpers
...
self.select_item(self.search_result)
you need to use find_and_send_keys here for sending $35.00 and Under text then click on the result(text or cbx, no matter)
"""